// test_registration.js - CommonJS версия
...
async function runTests() {
  ...
  // ТЕСТ 6: Очистка
  console.log('');
  console.log('❓ Удалить тестовые данные? (запустите с флагом --cleanup)');
  ...
  if (shouldCleanup) {
    ...
    console.log('   Пример: node test_registration.js --cleanup');
  }
